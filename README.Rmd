---
title: "MStargetR <img src='man/figures/logo.png' style='float: right; height:50px;' />"
...
MStargetR provides a pipeline for processing and quality control of targeted 
...
due to system architecture limitations. User's with these devices will be unable 
to use msConvertR or PeakForgeR with method set to skyline.
...
## Installation
**`Docker Desktop`**
Users are required to install Docker in order to run MStargetR::msConvertR and MStargetR::PeakForgeR.  
Please visit https://www.docker.com/get-started/ for installation process.

Note: Please ensure Docker Application is running in the background when using MStargetR if you are using a Mac or Windows OS.

**`MStargetR`**
Installation is effortless with the below helper function.
Once the package is attached you will be asked for a username and a default
default workflow will open for your convenience.
``` r
...
Szemray, H., Nambiar, V., Lawler, N., Lodge, S., Wist, J.,&  Whiley, L. (2025). MStargetR (Version 1.0.0) [Computer software]. Zenodo.(zenodo link)
...
[user-guide]: https://Hszemray.github.io/MStargetR/MStargetR-vignette.html
